...
\newcommand\mytitle{Bagged filters for partially observed interacting systems}

\newcommand\MainFigureBmScaling{1}
\newcommand\MainFigureMeaslesSim{2}
\newcommand\MainFigureMeaslesScaling{3}
\newcommand\MainFigureMeaslesSlice{4}
\newcommand\MainFigureMeaslesProfile{5}
\newcommand\MainSecProfile{4.3}
...
\newcommand\SuppSecLatentStates{S10}
\newcommand\SuppSecParameterEst{S11}
\newcommand\SuppSecIvsJ{S12}
\newcommand\SuppSecFixedU{S13}
\newcommand\SuppSecConstraint{S14}
\newcommand\SuppSecAssumption{S15}

\newcommand\filts{k}
\newcommand\Filts{K}
\newcommand\filtFunc{\phi}
\newcommand\filtFuncSet{\Phi}
...
%\title{Ensemble filters for partially observed spatiotemporal systems}

%\title{Bagged filters for partially observed spatiotemporal systems}
...
%\newenvironment{jpdel}{\color{lightbrown}}{} % suggested deletion by joonha
%teal for TODO
